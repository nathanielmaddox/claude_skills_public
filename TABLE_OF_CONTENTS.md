...
| 2 | [Design & UX](design_ux/README.md) | `design_ux/` | 8 | UI reviews, accessibility, landing pages, dashboards, mobile, booking |
...
| 5 | [Quality & Security](quality_security/README.md) | `quality_security/` | 7 | Testing, security audits, compliance, code review, QA enforcement |
| 6 | [Error Fixing](error_fixing/README.md) | `error_fixing/` | 9 | API, build, DB, dependency, ESLint, hydration, test, TS errors |
...
| 13 | [Database & Backend](database_backend/README.md) | `database_backend/` | 3 | Supabase, Convex, auth flows |
...
| 19 | [Workflow & Utilities](workflow_utilities/README.md) | `workflow_utilities/` | 8 | Deploy, simplify, loop, save progress, team, config |
